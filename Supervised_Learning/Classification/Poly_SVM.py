...
d = int(input("Enter polynomial degree: ")) # degree
z = int(input("Enter internal constant: ")) # internal constraint

# Training the Model
Kernel = (dat_train @ dat_train.T + z) ** d
...
# Testing the model
K_test = (dat_test @ dat_train.T + z) ** d
test_pred =  (alpha * tgt_train) @ K_test.T + b
...
K_in = (vals @ dat_train.T + z) ** d
pred = (alpha * tgt_train) @ K_in + b
